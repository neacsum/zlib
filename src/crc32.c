 ...
 */
local void write_table (FILE* out, const z_crc_t* table, int k)
{
    int n;
 ...
 */
local void write_table32hi (FILE* out, const z_word_t* table, int k)
{
    int n;
...
/*
  ...
  accordingly.
 */
local void write_table64 (FILE* out, const z_word_t* table, int k)
{
    int n;
